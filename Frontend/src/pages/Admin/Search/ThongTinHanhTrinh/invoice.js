      ...
      <div ref={componentPDF}>
        {data?.data?.thongtinhanhkhach.map((value, index) => {
          return (
            <div
              key={index}
              className={clsx(styles.wrapper, 'm-auto border')}
              style={{ width: '768px' }}
            >
              ...
              <h6 className="text-center">
                ...
                province MST / Taxcode: 1700556108
              </h6>
              <div className="d-flex flex-row justify-content-center mt-3 ">
                <h2 className="fw-bold me-3">MUA VÉ TẠI QUẦY</h2>
                <div>
              ...
              <div className="p-5 mx-auto mt-3" style={{ fontSize: '1.2rem' }}>
                <table className="px-5">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{moment(data.thoigiandi).format('L LT')}</td>
                    </tr>
                    <tr>
                      <td> Họ tên / Name: </td>
                      <td>{value.hoten}</td>
              ...
              <div className="d-flex flex-row">
                ...
                <div>
                  <p>
                    ...
                    thông tin in trên thẻ / Your boarding pass's information must match
                  ...
                  <p>
                    Ghi chú: Để tra cứu và nhận hóa đơn điện tử xin vui lòng truy cập địa
                    chỉ web
                    <br />
