...
function bodyMailUpdateBack(data) {
  let message = "";
...
function templateMailUpdateBillBack(data, diadiem, children) {
  return `
  <div style="margin:0px auto;padding:20px;border: 1px solid gray;">
    <div style="font-size:20px">
      ...
      <p>
        ...
        của quý khách đã được thay đổi do yêu cầu đổi vé từ quý khách 
        
      </p>
      <p>
      <strong>Lưu ý : </strong>Việc thực hiện thay đổi vé này, chỉ được phép thực hiện một lần</p>
    </div>
      ...
      <p>
        ...
        <span style="color:rgb(241,88,35)">
          <strong>
            ${diadiem.diemden} - ${diadiem.diemdi}
          </strong>
        </span>
      </p>
      <p>
      ...
      <table style="width:100%;border:1px solid gray">
        ...
        <tbody style="background-color:#F3F9FD">
          ...
          <td style="font-size:17px">
            ...
            <p>${moment(data.thoigiankhuhoi).format("DD/MM/YYYY")}</p>
            <p>${moment(data.thoigiankhuhoi).format("LT")}</p>
          </td>
          <td style="font-size:17px">
            <p style="text-transform:uppercase;color:rgb(241,88,35) ">
              ${diadiem.diemdi}
...
module.exports = { bodyMailUpdateBack, templateMailUpdateBillBack };
