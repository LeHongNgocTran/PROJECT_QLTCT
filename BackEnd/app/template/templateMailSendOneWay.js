...
function templateMailSendOneWay(data, diadiem, children) {
  return `
  <div style="margin:0px auto;padding:20px;border: 1px solid gray;">
    <div style="font-size:20px">
      <h2 style="color:blue;font-weight: bold;text-transform: uppercase">
        Công ty CP TÀU CAO TỐC
      </h2>
      <p>
        Kính chào quý khách hàng,
        <br />
        Cảm ơn quý khách đã mua vé tàu online của Công Ty CP Tàu Cao Tốc
      </p>
      <br />
...
module.exports = { bodyMail, templateMailSendOneWay };
