...
function templateMailSendTwoWay(data, diadiem, children) {
  return `
        ...
        <tbody style="background-color:#F3F9FD">
          <tr>
            ...
            <td style="font-size:17px">
              ...
              <p>${moment(data.thoigiandi).format("DD/MM/YYYY")}</p>
          ...
          <td style="font-size:17px">
            ...
            <p>${moment(data.thoigiankhuhoi).format("L")}</p>
...
module.exports = { bodyMailTwoWay, templateMailSendTwoWay };
